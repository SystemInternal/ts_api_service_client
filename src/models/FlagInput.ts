...
/**
 * Check if a given object implements the FlagInput interface.
 */
export function instanceOfFlagInput(value: object): value is FlagInput {
    if (!('flaggedProperty' in value) || value['flaggedProperty'] === undefined) return false;
    return true;
}

export function FlagInputFromJSON(json: any): FlagInput {
    return FlagInputFromJSONTyped(json, false);
}

export function FlagInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlagInput {
    if (json == null) {
        return json;
    }
    return {
...
export function FlagInputToJSON(value?: FlagInput | null): any {
    if (value == null) {
        return value;
    }
    return {
